...
<title>Booking Homestay Network</title>
<meta name="viewport"
				...
				.click(
						function() {
							...
							if (obj.data('liked')) {
								...
								obj.data('liked', true);
								obj
										.html('<span style="font-weight:700; color:green;"><i class="glyphicon glyphicon-thumbs-up" style="font-weight:700;"></i> Like</span>');
							}
						});
	});
...
<body>
	<div class="wrapper">
		...
		<div class="container" id="content">
			<div class="row">
				<!-- Center content -->
				<jsp:include page="_centerContent.jsp" />
				<!-- Left content -->
